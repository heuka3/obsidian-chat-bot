...
exports.testWikipediaFunctions = testWikipediaFunctions;
const index_js_1 = require("../src/index.js");
async function testWikipediaFunctions(query) {
    console.log(`\n=== Testing Wikipedia functions with query: "${query}" ===\n`);
    try {
        // 1. 검색 결과 테스트
        console.log('1. Testing get_wiki_search...');
        console.log('-----------------------------------');
        const searchResults = await (0, index_js_1.get_wiki_search)(query);
        ...
        console.log('-----------------------------------');
        try {
            const intro = await (0, index_js_1.get_wiki_intro)(testTitle);
        ...
        console.log('-----------------------------------');
        try {
            const summary = await (0, index_js_1.get_wiki_summary)(testTitle);
        ...
        console.log('-----------------------------------');
        try {
            const content = await (0, index_js_1.get_wiki_content)(testTitle);
